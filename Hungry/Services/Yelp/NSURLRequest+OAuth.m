...
static NSString * const kConsumerKey       = @"BS-264XamAnPO26kh4-SKw";
static NSString * const kConsumerSecret    = @"U4AuB2qNWt_mgp10wG_fN9ANsLI";
static NSString * const kToken             = @"mwtUAQ7xGZ5ZblM9lq8GfFY90XNs5sig";
static NSString * const kTokenSecret       = @"s6DoMKkXfFIT4LmnYuSNwvfx6Uw";
