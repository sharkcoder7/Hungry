...
+ (void)showImage:(UIImage *)image status:(NSString *)string duration:(NSTimeInterval)seconds {
    [[SVProgressHUD sharedView] showImage:image status:string duration:seconds];
}
